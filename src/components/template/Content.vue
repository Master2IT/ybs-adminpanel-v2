<template>
  ...
  <div class=" container-xxl " id="kt_content_container">
    ...
    <div class="row g-5 g-xl-8">
      <!--begin::Col-->
      <div class="col-xl-4">
        <!--layout-partial:partials/widgets-2/misc/_widget-1.html-->
      ...
      <div class="col-xl-8 ps-xl-12">
        <!--layout-partial:partials/widgets-2/engage/_widget-1.html-->
        <!--begin::Row-->
        <div class="row g-5 g-xl-8">
          <!--begin::Col-->
          <div class="col-xl-6">
            <!--layout-partial:partials/widgets-2/mixed/_widget-5.html-->
          </div>
          <!--end::Col-->
          <!--begin::Col-->
          <div class="col-xl-6">
        ...
        <div class="row g-5 g-xl-8">
          ...
          <!--begin::Col-->
          <div class="col-xl-6">
            <!--layout-partial:partials/widgets-2/mixed/_widget-8.html-->
          </div>
          <!--end::Col-->
        </div>
        <!--end::Row-->
